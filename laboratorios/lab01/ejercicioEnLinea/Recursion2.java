...
/**  
* El método splitOdd10 se encarga de recibir un arreglo para que sea analizado en el método helper
* @see helper()
* @param nums, el arreglo del que se quiere generar grupos
...
/**  
* El método split53 se encarga de recibir un arreglo para que sea analizado en el método helper2
* @see helper2()
* @param nums, el arreglo del que se quiere generar grupos
* @return valor booleano sobre si existe una posible división del arreglo
*/
